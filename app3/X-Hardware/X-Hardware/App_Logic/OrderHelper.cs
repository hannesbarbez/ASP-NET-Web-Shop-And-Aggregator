...
namespace app0.App_Logic
{
    internal static class OrderHelper
    {
        ...
        internal static void MailOrderDetails(string emailaddress)
        {
            ...
            string body = "X-Hardware.notld order confirmation" + Environment.NewLine + Environment.NewLine + "Thank you for purchasing with us!" + Environment.NewLine
            ...
            SendMail(emailaddress, "fakefakefakedomain@x-hardware.notld", subj, body);
        }
