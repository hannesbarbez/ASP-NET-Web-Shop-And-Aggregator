...
namespace app0
{
    public partial class ViewProduct : System.Web.UI.Page
    {
        ...
        protected void lvProdDetail_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            ltProdMan.Text += p.UthManufacter.man_name;
            ...
            hlEnlargeImage.Attributes.Add("title", p.UthManufacter.man_name + " " + p.prod_name);
        ...
        protected void lvAlsoBought_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            prod_man.Text = p.UthManufacter.man_name.ToString();
